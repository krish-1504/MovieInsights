        ...
        <div className="h-[55vh] lg:h-[60vh] w-full flex justify-start items-center">
            ...
            {/* <div className="absolute w-[90%] lg:w-[40%] mx-auto">
                ...
                <div className="flex gap-x-3 mt-4">
                    <MovieButtons age={data?. as number} duration={data?.duration as number} id={data?.id as number} overview={data?.overview as string} releaseDate={data?.release as number} title={data?.title as string} youtubeUrl={data?.youtubeString as string} key={data?.id}></MovieButtons>
                </div>
            </div> */}
        </div>
